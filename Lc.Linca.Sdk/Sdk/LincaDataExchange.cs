...
public static class LincaDataExchange
{
    ...
    /// sets the status of the dispense to 'entered-in-error'
    /// </summary>
    public static (OperationOutcome oo, bool deleted) DeleteHL7ATCorePatient(LincaConnection connection, string id)
    {
        return FhirDataExchange<Patient>.DeleteResource(connection, id, LincaEndpoints.HL7ATCorePatient);
    }
